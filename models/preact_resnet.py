...
def PreActResNet50(dataset, num_classes, input_normalization, enable_batchnorm):
    return PreActResNet(PreActBottleneck, [3,4,6,3], dataset, num_classes, input_normalization, enable_batchnorm)
